      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="flex flex-col gap-8">
            ...
            <div className="mt-4 pt-8 border-t border-primary/10">
              <h3 className="text-sm font-black text-primary uppercase tracking-wider mb-4">Follow Our Journey</h3>
              <div className="flex gap-4">
                {['facebook', 'twitter', 'instagram'].map((social) => (
                  <a key={social} href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-primary shadow-md hover:-translate-y-1 transition-all border border-primary/5">
