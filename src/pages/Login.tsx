...
const Login = () => {
    ...
    return (
        <div className="flex min-h-[calc(100vh-80px)] items-center justify-center p-6 sm:p-12 lg:p-20 relative overflow-hidden">
            ...
            <main className="relative z-10 w-full max-w-5xl rounded-[2.5rem] bg-[#fdfaf2] shadow-[0_25px_80px_-15px_rgba(61,37,22,0.3)] border-[0.5px] border-primary/20 flex flex-col lg:flex-row overflow-hidden group">
                ...
                <div className="flex-1 p-8 sm:p-12 lg:p-16 flex flex-col justify-center bg-[#fdfaf2] relative">
                    ...
                    <div className="max-w-md mx-auto w-full">
                                        ...
                                        <input
                                            ...
                                            className={`w-full rounded-2xl border-2 transition-all duration-300 ${
                                                formik.touched[field.id as keyof typeof formik.values] && formik.errors[field.id as keyof typeof formik.values]
                                                    ...
                                                    : 'border-[#f4ecd8] bg-[#f8f5ee] focus:border-primary/30 focus:bg-white shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)]'
                        ...
                        <div className="mt-12 text-center relative">
                            ...
                            <span className="relative z-10 bg-[#fdfaf2] px-4 text-[10px] font-black uppercase tracking-[0.3em] text-primary/40">No connection?</span>
                        </div>
